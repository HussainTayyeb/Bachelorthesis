package com.example.swipe_stack_layout;
...
public class SwipeHelper implements View.OnTouchListener {
    ...
    //checks if card position when leaving the touch on the card
    ...
    //resets the card to the middle position
